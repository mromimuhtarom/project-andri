						...
						<div class="col-sm-8">
							<div class="shop-menu pull-right">
								<ul class="nav navbar-nav">
									...
									<li><a href="{{ route('profile-view') }}" style="background:none !important"><i class="fa fa-user"></i>Profile</a></li>
									...
									<li><a href="{{ route('loginuser')}}" style="background:none !important"><i class="fa fa-lock"></i> Login</a></li>
									@endif
								</ul>
							</div>
						</div>
